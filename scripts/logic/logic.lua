...
function can_flash()
	return (
		has("op_hm5_off") or (has("hm05") and has("knucklebadge"))
	)
end
...
function slateport_access()
	return (can_freefly("5") 
	or has("stevenletter") 
	or can_surf() 
	or ferry_from_lilycove() 
	or (
		(
			can_freefly("6") 
			or can_freefly("7") 
...
function sootopolis_access()
	return (can_freefly("13") and can_surf()) or (rt124_access() and can_dive())
end
